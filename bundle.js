  	...
  	if (this.state.editing) {
  		return React.createElement("span", {style: styles.container}, React.createElement("input", {ref: "titleinput", style: styles.input, 
  					autofocus: true, onKeyUp: this.onKeyUp, 
  								...
  								React.createElement("button", {onClick: this.props.onOpenToc}, "Toc")
  						)
  	} else {
...
var LeftPanel = React.createClass({displayName: "LeftPanel",
  ...
  ,render :function() {
      ...
      React.createElement(TabPanel, null, 
	      React.createElement("div", {style: this.panelstyle}, 
        React.createElement("h2", null, React.createElement(OutlinePanel, {localfilesystem: this.props.localfilesystem}))
	  		)
...
var GooglePanel=React.createClass({displayName: "GooglePanel",
	...
	,render:function() {
		...
		React.createElement(RecentFiles, {opening: this.state.opening, files: this.state.recentfiles, 
...
var RecentFiles=React.createClass({displayName: "RecentFiles",
	...
	,renderClear:function(){
		if (this.props.files.length>20) return React.createElement("button", {onClick: this.clear}, "Clear rarely used items")
	}
	,render:function(){
		if (this.props.opening) {
			return React.createElement("div", null, "Opening file ", this.props.opening)
		} else {
			return React.createElement("div", null, React.createElement("div", null, this.props.files.map(this.renderItem)), 
			React.createElement("div", null, this.renderClear())
			)	
		}
	}
});
...
ksanagap.boot("dualfilter-sample",function(){
	var Main=React.createElement(require("./containers/main"));
	ksana.mainComponent=ReactDOM.render(Main,document.getElementById("main"));
});
},{"./containers/main":"C:\\ksana2015\\pannaloka\\src\\containers\\main.js","ksana2015-webruntime/ksanagap":"C:\\ksana2015\\node_modules\\ksana2015-webruntime\\ksanagap.js","ksana2015-webruntime/livereload":"C:\\ksana2015\\node_modules\\ksana2015-webruntime\\livereload.js","react":"react","react-dom":"react-dom"}],"C:\\ksana2015\\pannaloka\\src\\markup\\find.js":[function(require,module,exports){
...
},{"../actions/ktcfile":"C:\\ksana2015\\pannaloka\\src\\actions\\ktcfile.js","../socketfs":"C:\\ksana2015\\pannaloka\\src\\socketfs.js","../textview/googledrive":"C:\\ksana2015\\pannaloka\\src\\textview\\googledrive.js","reflux":"C:\\ksana2015\\node_modules\\reflux\\index.js"}],"C:\\ksana2015\\pannaloka\\src\\stores\\ktxfile.js":[function(require,module,exports){
var Reflux=require("reflux");
var socketfs=require("../socketfs");
var KTXFileStore=Reflux.createStore({
...
},{"../actions/docfile":"C:\\ksana2015\\pannaloka\\src\\actions\\docfile.js","../actions/ktcfile":"C:\\ksana2015\\pannaloka\\src\\actions\\ktcfile.js","../actions/ktxfile":"C:\\ksana2015\\pannaloka\\src\\actions\\ktxfile.js","../actions/markup":"C:\\ksana2015\\pannaloka\\src\\actions\\markup.js","../actions/selection":"C:\\ksana2015\\pannaloka\\src\\actions\\selection.js","../actions/stackwidget":"C:\\ksana2015\\pannaloka\\src\\actions\\stackwidget.js","../cmfileio":"C:\\ksana2015\\pannaloka\\src\\cmfileio.js","../stores/markup":"C:\\ksana2015\\pannaloka\\src\\stores\\markup.js","./googledrive":"C:\\ksana2015\\pannaloka\\src\\textview\\googledrive.js","./highlight":"C:\\ksana2015\\pannaloka\\src\\textview\\highlight.js"}],"C:\\ksana2015\\pannaloka\\src\\textview\\googledrive.js":[function(require,module,exports){
